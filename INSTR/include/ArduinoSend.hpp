...
public:
    ArduinoSend(const std::string& port = "/dev/ttyCH341USB0"); // class constructor
    ...
    void closePort();
    void flushCache();
    std::vector<double> readMotorPosition(std::ofstream& logFile);
    std::string readStringResponse();
